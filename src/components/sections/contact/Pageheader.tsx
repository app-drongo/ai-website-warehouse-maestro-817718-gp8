...
const DEFAULT_PAGEHEADER = {
  title: 'Get in Touch',
  description:
    'Ready to transform your warehouse operations? Our team of supply chain experts is here to help you implement the perfect solution for your business.',
  ctaText: 'Schedule Demo',
  ctaHref: '#contact-form',
  hasBackground: false, // Toggle for background color
  stat1Label: 'Warehouses Served',
  stat1Value: '500+',
  stat2Label: 'Faster Processing',
  stat2Value: '40%',
