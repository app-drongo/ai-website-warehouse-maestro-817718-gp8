...
const DEFAULT_HERO = {
  ...
  description:
    'Streamline inventory management, optimize workflows, and boost productivity with our comprehensive warehouse management system. Built for modern supply chain professionals.',
  features: [
