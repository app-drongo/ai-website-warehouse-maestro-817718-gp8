...
const DEFAULT_CTA = {
  badge: 'Transform Your Operations Today',
  mainTitle: 'Ready to Optimize Your',
  mainTitleHighlight: 'Warehouse Operations?',
  description:
    'Join hundreds of warehouse managers who have streamlined their operations with Warehouse Maestro. Start your free trial and experience 40% faster order processing.',
  primaryCTA: 'Start Free Trial',
  primaryCTAHref: '/pricing',
  secondaryCTA: 'Schedule Demo',
  secondaryCTAHref: '/contact',
  trustText: 'Trusted by leading logistics companies worldwide',
  stat1Value: '500+',
  stat1Label: 'Warehouses',
  stat2Value: '99.8%',
  stat2Label: 'Uptime SLA',
  stat3Value: '40%',
  stat3Label: 'Faster Processing',
  stat4Value: '24/7',
  ...
  feature3Title: 'Quick Implementation',
  feature3Description: 'Go live in 2 weeks with our expert onboarding team',
} as const;
