...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    "Connect with our warehouse management experts to discover how Warehouse Maestro can streamline your operations, reduce costs, and boost efficiency. We're here to answer your questions and provide a personalized demo.",
  formTitle: 'Request a Consultation',
  formDescription:
    "Tell us about your warehouse challenges and we'll show you how our ERP solution can help. Our team will respond within 2 business hours.",
  submitButton: 'Schedule Demo',
  contactSectionTitle: 'Connect With Our Team',
  method1Title: 'Sales Inquiries',
  method1Description: 'Speak with our solutions experts',
  method1Contact: 'sales@warehousemaestro.com',
  method2Title: 'Support Hotline',
  method2Description: '24/7 technical assistance',
  method2Contact: '+1 (800) 555-WAREHOUSE',
  method3Title: 'Live Chat',
  method3Description: 'Instant support & demos',
  method3Contact: 'Available 6 AM - 10 PM EST',
  officesSectionTitle: 'Global Offices',
  office1City: 'Chicago, IL',
  office1Address: '1200 Logistics Blvd, Suite 400',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Los Angeles, CA',
  office2Address: '3500 Supply Chain Ave, Floor 12',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'Atlanta, GA',
  office3Address: '850 Distribution Way, Building C',
  ...
  supportNote: 'Enterprise customers receive priority 24/7 support with dedicated account managers',
  nameLabel: 'Full Name *',
  namePlaceholder: 'John Smith',
  emailLabel: 'Business Email *',
  emailPlaceholder: 'john.smith@company.com',
  companyLabel: 'Company Name *',
  companyPlaceholder: 'ABC Logistics Inc.',
  messageLabel: 'Tell Us About Your Warehouse *',
  messagePlaceholder:
    "Describe your current warehouse size, inventory volume, main challenges, and what you're looking to improve...",
} as const;
